        ...
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-2 mt-4">
            ...
            {popularSearches.map((search) => (
              <Badge key={search} variant="outline" className="cursor-pointer hover:bg-muted">
                {search}
              </Badge>
            ))}
          </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {videoTutorials.map((video, idx) => (
              <Card key={idx} className="border-border hover:shadow-lg transition-shadow group cursor-pointer">
                <CardContent className="p-0">
                  <div className="aspect-video bg-muted rounded-t-lg flex items-center justify-center relative overflow-hidden">
                    ...
                    <div className="absolute bottom-2 right-2 bg-near-black/80 text-white px-2 py-1 rounded text-xs font-medium">
                      {video.duration}
                    </div>
                  </div>
                  <div className="p-4">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    className="w-full min-h-32 px-3 py-2 rounded-md border border-input bg-background text-sm resize-none"
